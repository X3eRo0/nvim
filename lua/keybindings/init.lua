...
map("n", "<leader>f", ":Telescope find_files theme=get_ivy<cr>", { noremap = true, silent = true })
map("n", "<leader>r", ":Telescope live_grep theme=get_ivy<cr>", { noremap = true, silent = true })
